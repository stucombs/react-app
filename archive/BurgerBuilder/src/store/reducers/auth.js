...
const reducer = (state=initialState, action) => {
	switch(action.type){
		case actionTypes.AUTH_START: return updateObject(state, {error: null, loading: true}); break;
		...
		case actionTypes.SET_AUTH_REDIRECT_PATH: return setAuthRedirect(state, action); break;
